  ...
  return (
    <div className="py-10 md:py-20 bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-xl shadow-shop_light_blue p-8 max-w-md w-full space-y-8"
      >
        <motion.div
          animate={{
            scale: [1, 1.1, 1],
        ...
        >
          <Image
            ...
            layout="fill"
            objectFit="contain"
            className="drop-shadow-lg shadow-shop_light_blue"
          />
          <motion.div
            animate={{
              x: [0, -10, 10, 0],
            ...
            className="absolute -top-4 -right-4 bg-shop_light_blue rounded-full p-2"
          >
