...
const StaticHomeBanner = () => {
  return (
    <div className="md:flex gap-3">
      <div className="py-16 mb-2 md:w-[50%] mt-4 md:py-16 h-16 md:h-64 lg:h-50 bg-shop_light_pink rounded-lg px-10 lg:px-10 flex items-center justify-between">
        <div className="">
          <Title className="md:pb-5 pb-2 font-sans">
      ...
      <div className="py-16 h-16 md:h-64 lg:h-50 md:w-[50%] md:mt-4 md:py-0 bg-green-100 rounded-lg px-10 lg:px-10 flex items-center justify-between">
        <div>
