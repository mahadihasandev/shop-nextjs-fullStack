  ...
  return (
    <div className="">
      <Container>
        ...
        <div className="flex flex-col md:flex-row rounded-md gap-2 shadow-[0px_-2px_10px_-4px_#1E90FF]">
          <div
            className="md:sticky md:top-20 md:self-start shadow-[2px_-1px_10px_-4px_#1E90FF] rounded-md
